  ...
  return (
    <div className="max-w-5xl mx-auto my-10">
      ...
      <div className="space-y-5 my-5">
        <p>
          This Privacy Policy describes how Tabletop Zealot (the "Site", "we",
          "us", or "our") collects, uses, and discloses your personal
          information when you visit, use our services, or make a purchase from
          https://board-games-store-kappa.vercel.app/ (the "Site") or otherwise
      ...
      <div className="space-y-5 mt-5">
        ...
        <ul className="list-disc ml-10">
          ...
          <li>
            ...
            message through the Services or through email.
          </li>
        </ul>
        <p>
        ...
        <p>
          ...
          your activity, browser, and device. Cookies are small text files that
          are stored on your browser or device by websites, apps, online media,
          and advertisements. We may use cookies to:
        </p>
        <ul className="list-disc ml-10">
          <li>Remember and add products to your cart</li>
          <li>Remember your preferences</li>
          <li>Give security tokens to use certain Services</li>
        </ul>
        <h3 className="text-xl text-blue-600">
          Section 3: Information We Obtain from Third Parties
        </h3>
        <p>
          We may receive information about you from third parties, including
          service providers and advertising partners. This information may
          include:
        </p>
        <ul className="list-disc ml-10">
          <li>
            Our payment processors (Stripe), who collect payment information
            (e.g., bank account, credit or debit card information, billing
            address) to process your payment in order to fulfill your orders and
        ...
        <ul className="list-disc ml-10">
          <li>
            ...
            you, including to process your payments, fulfill your orders, to
            send notifications to you related to you account, purchases,
      ...
      <div className="space-y-5 mt-5">
        <h2 className="text-xl text-blue-600">Cookies</h2>
        <p>
      ...
      <div className="space-y-5 mt-5">
        ...
        <ul className="list-disc ml-10">
          ...
          <li>
            Right to Delete / Erase. You may have the right to request that we
            delete personal information that we hold about you.
          </li>
          <li>
          ...
          <li>
            ...
            defined in applicable privacy laws. Please note that if you visit
            our Site with the Global Privacy Control opt-out preference signal
            enabled, depending on where you are, we will automatically treat
            this as a request to opt-out of the "sale" or "sharing" of
        ...
        <h2 className="text-xl text-blue-600">Complaints</h2>
        <p>
        ...
        <h2 className="text-xl text-blue-600">International Users</h2>
        <p>
          Please note that we do not currently ship or sell to international
          customers outside the USA. This may change in the future, and we will
          update this Privacy Policy accordingly.
        </p>
        <h2 className="text-xl text-blue-600">Contact</h2>
        <p>
          ...
          available to you, please send us an email at
          tabletopzealotsupport@gmail.com (not real email address yet)
        </p>
      </div>
    </div>
  );
